                ...
                <div class="product product-single row">
                        ...
                        <div class="product-gallery product-gallery-sticky">
                            <div class="swiper-container product-single-swiper swiper-theme nav-inner" data-swiper-options="{
                                ...
                                <div class="swiper-wrapper row cols-1 gutter-no">
                                    <div class="swiper-slide">
                                        <figure class="product-image">
                                            <img src="/storage/product_display_images/{{$product->image}}"
                                                data-zoom-image="/storage/product_display_images/{{$product->image}}"
                                    ...
                                    <div class="swiper-slide">
                                        <figure class="product-image">
                                            <img src="/storage/product_images/{{$pi->name}}"
                                                data-zoom-image="/storage/product_images/{{$pi->name}}"
                    ...
                    <div class="col-md-6 mb-4 mb-md-6">
                        <div class="product-details" data-sticky-options="{'minWidth': 767}">
                            ...
                            <div class="product-price"><ins class="new-price">${{number_format($product->price,2)}}</ins></div>
                            ...
                            <div class="product-short-desc">
                                @php
                                    $featureToArray = explode(',',$product->features);
                                @endphp
                                <ul class="list-type-check list-style-none">
                                    @foreach ($featureToArray as $item)
                                        <li>{{$item}}</li>
                                    @endforeach
                            ...
                            <div class="fix-bottom product-sticky-content sticky-content">
                                <div class="product-form container">
                                    <a href="{{route('user.add_to_cart', $product->id)}}">
...
<!-- End of Page Content -->
@endsection
@section('details-footer-content')
