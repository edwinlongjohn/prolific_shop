...
<main class="main">
    ...
    <div class="container">
                    ...
                    <div class="product text-center">
                        <figure class="product-media">
                            <a href="{{route('view_product',$product->id)}}">
                                <img src="/storage/product_display_images/{{$product->image}}" alt="Product" width="300"
                                    height="338" />
                            </a>
                        ...
                        <div class="product-details">
                            <h4 class="product-name"><a href="{{route('view_product',$product->id)}}">{{$product->name}}
                                </a></h4>
                            <div class="ratings-container">
                                <div class="ratings-full">
                                    <span class="ratings" style="width: 60%;"></span>
                                ...
                                <a href="{{route('view_product',$product->id)}}" class="rating-reviews">(3 reviews)</a>
                            </div>
                            <div class="product-price">
        ...
        <div class="product-wrapper-1 appear-animate mb-7">
            <div class="title-link-wrapper pb-1 mb-4">
                <h2 class="title ls-normal mb-0">Dashboard Garden & Kitchen</h2>
                <a href="shop-boxed-banner.html" class="font-size-normal font-weight-bold ls-25 mb-0">More
                    Products<i class="w-icon-long-arrow-right"></i></a>
            </div>
            <div class="row">
                        ...
                        <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                            <div class="swiper-slide product-col">
                                <div class="product-wrap product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="product-default.html">Dashboard Sofa</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 100%;"></span>
            ...
            <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
                ...
                <div class="swiper-slide product-wrap mb-0">
                    <div class="product text-center product-absolute">
                        ...
                        <h4 class="product-name">
                            <a href="product-default.html">Dashboard Sofa</a>
                        </h4>
                    </div>
                </div>
                <!-- End of Product Wrap -->
